...
public class Application8 {
	...
	private static final String LOGBACK_FILE = "src/test/resources/sample8.xml";
	...
	public static void main(String[] args) {
		...
		application.display("Testing SMTP appenderTesting SMTP appenderTesting SMTP appenderTesting SMTP appenderTesting SMTP appenderTesting SMTP appenderTesting SMTP appender");
